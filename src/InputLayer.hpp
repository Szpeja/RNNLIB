...
{
	//functions
	InputLayer(const string& name, size_t numSeqDims, size_t size, const bimap<int, string>& labels, WeightContainer* wc, DataExportHandler* dEH):
		Layer(name, numSeqDims, 0, size, wc, dEH)
	{
